...
s6_h = getKeysWithHighestValueMinPAs(milrstats6, 10, stat_request, result_request, minresult, maxresult);
...
addRows(s6_h, "s6-hits-lb", stat_request, milrstats6);	
	}
		if(highlow == "lowest") {
...
s6_h = getKeysWithLowestValueMinPAs(milrstats6, 10, stat_request, result_request, minresult, maxresult);
//console.log(s3_h);
addRows(s0_h, "s0-hits-lb", stat_request, milrstats);
addRows(s3_h, "s3-hits-lb", stat_request, milrstats3);
addRows(s4_h, "s4-hits-lb", stat_request, milrstats4);

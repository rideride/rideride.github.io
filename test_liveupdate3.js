...
r.permissions = _.extend(r.permissions || {}, {
    liveupdate_contributor_invite: {
        settings: {
            description: r.N_("change the title and description"),
            title: r.N_("settings")
        },
        edit: {
            description: r.N_("strike and delete others' updates"),
            title: r.N_("edit")
        },
        manage: {
            description: r.N_("add, remove, and change permissions of contributors"),
            title: r.N_("manage contributors")
        },
        update: {
            description: r.N_("post updates"),
            title: r.N_("update")
        },
        discussions: {
            description: r.N_("unlink posts discussing this thread"),
            title: r.N_("hide discussions")
        },
        close: {
            description: r.N_("permanently close the live thread"),
            title: r.N_("close live thread")
        }
    },
...
;r.i18n.addMessages({
    "post updates": [null, "post updates"],
    "connecting to update server": [null, "connecting to update server"],
    "close live thread": [null, "close live thread"],
    "manage contributors": [null, "manage contributors"],
    "permanently close the live thread": [null, "permanently close the live thread"],
    "live": [null, "live"],
    "connecting": [null, "connecting"],
    "strike": [null, "strike"],
    "resources": [null, "resources"],
    "you reported this live thread for: %(violation)s": [null, "you reported this live thread for: %(violation)s"],
    "striking\u2026": [null, "striking\u2026"],
    "deleted": [null, "deleted"],
    "add, remove, and change permissions of contributors": [null, "add, remove, and change permissions of contributors"],
    "popup notifications": [null, "popup notifications"],
    "update": [null, "update"],
    "strike and delete others' updates": [null, "strike and delete others' updates"],
    "disconnected. retrying in %(delay)s second...": [null, "disconnected. retrying in%(delay)s second...", "disconnected. retrying in%(delay)s seconds..."],
    "submitting report\u2026": [null, "submitting report\u2026"],
    "%(num)s viewer": [null, "%(num)s viewer", "%(num)s viewers"],
    "no further updates": [null, "no further updates"],
    "settings": [null, "settings"],
    "edit": [null, "edit"],
    "could not connect to update servers. please refresh": [null, "could not connect to update servers. please refresh"],
    "stricken": [null, "stricken"],
    "deleting\u2026": [null, "deleting\u2026"],
    "change the title and description": [null, "change the title and description"],
    "updating in real time": [null, "updating in real time"],
    "delete": [null, "delete"]
});
